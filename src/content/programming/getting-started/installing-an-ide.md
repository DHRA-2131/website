...
<figure><img src={`${base}images/assets/image (2) (1).png`} alt=""><figcaption></figcaption></figure>

Head to the settings (Gear symbol in the bottom left corner) and hover over the profiles option to select profile.&#x20;

<figure><img src={`${base}images/assets/image (1) (1) (1) (1).png`} alt=""><figcaption></figcaption></figure>
...
<figure><img src={`${base}images/assets/image (3).png`} alt=""><figcaption></figcaption></figure>
...
<figure><img src={`${base}images/assets/image (4).png`} alt=""><figcaption></figcaption></figure>
